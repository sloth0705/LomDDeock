...
import character from "../../images/brand/1_1character.png";
        ...
        <Container>
            <div class="divContainer">
                ...
                <div className="brandIntro">
                    ...
                    <Image src={character} alt="character" className="character"/>
                </div>
                <h3 id="BI">BI(BRAND IDENTITY)</h3>
                <div className="BI">
